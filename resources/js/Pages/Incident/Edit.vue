...
const form = useForm({
    title: pros.incident_info.title,
    details: pros.incident_info.details,
    status: '',
    contact_person_name: pros.incident_info.contact_person_name,
    contact_person_number: pros.incident_info.contact_person_number,
    incident_address: pros.incident_info.incident_address,
});
const submit = () => {
    form.put(route('incidents.update',pros.incident_info.id), {
